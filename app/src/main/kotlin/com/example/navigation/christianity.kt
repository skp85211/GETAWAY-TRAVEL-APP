...
import kotlinx.android.synthetic.main.fragment_christianity.view.*
...
class christianity : Fragment() {
    ...
    override fun onCreateView(
        ...
        f.setOnClickListener {
            var j = 0
            if (christianityAdapter.checkedplaces.size > 0) {
                do {
                    var checked = christianityAdapter.checkedplaces[j]
                    var sb = checked.name
                ...
                } while (j < christianityAdapter.checkedplaces.size)
